...
(use-package everforest-theme
  ...
  (custom-set-faces
   ...
   ;; Git gutter & diff-hl Everforest colors
   '(diff-hl-insert ((t (:foreground "#b7d88d" :background "#3c5749"))))
   '(diff-hl-delete ((t (:foreground "#f28a8f" :background "#663f48"))))
   '(diff-hl-change ((t (:foreground "#8bcfc7" :background "#365e6d"))))
   '(diff-hl-dired-insert ((t (:foreground "#b7d88d" :weight bold))))
   '(diff-hl-dired-delete ((t (:foreground "#f28a8f" :weight bold))))
   '(diff-hl-dired-change ((t (:foreground "#8bcfc7" :weight bold))))
   '(diff-hl-dired-ignored ((t (:foreground "#89968c"))))
   '(git-gutter:added ((t (:foreground "#b7d88d" :weight bold))))
   '(git-gutter:deleted ((t (:foreground "#f28a8f" :weight bold))))
   '(git-gutter:modified ((t (:foreground "#8bcfc7" :weight bold))))
   '(git-gutter-fr:added ((t (:foreground "#b7d88d"))))
   '(git-gutter-fr:deleted ((t (:foreground "#f28a8f"))))
   '(git-gutter-fr:modified ((t (:foreground "#8bcfc7"))))))
